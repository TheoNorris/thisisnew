...
var _rockJpg = require("./images/rock.jpg");
var _rockJpgDefault = parcelHelpers.interopDefault(_rockJpg);
var _scissorsJpg = require("./images/scissors.jpg");
var _scissorsJpgDefault = parcelHelpers.interopDefault(_scissorsJpg);
let playerScore = 0;
let computerScore = 0;
let result = {};
...
function createGame(event) {
    ...
    descriptionP.innerText = "These are the rules of the game: You must choose either rock paper or scissors by clicking on the image in an attempt to beat the computer. The first player that wins three times is the winner!";
    ...
    const rockPaperSciss = [
        "rock",
        "paper",
        "scissors"
    ];
    const rpsImages = [
        (0, _rockJpgDefault.default),
        (0, _paperJpgDefault.default),
        (0, _scissorsJpgDefault.default)
    ];
    const computerDiv = createplayerDivs("Computer");
    computerDiv.style.width = "40%";
    const computerChoice = document.createElement("img");
    computerChoice.src = (0, _rockJpgDefault.default);
    ...
    for(let i = 0; i < rockPaperSciss.length; i++){
        ...
        rps.addEventListener("click", function() {
            ...
            if (rockPaperSciss[i] == `rock` && computerTurn == `scissors` || rockPaperSciss[i] == `paper` && computerTurn == `rock` || rockPaperSciss[i] == `scissors` && computerTurn == `paper`) {
                playerScore++;
                scoreHead.innerText = `Score: ${playerScore}`;
            } else if (computerTurn == `rock` && rockPaperSciss[i] == `scissors` || computerTurn == `paper` && rockPaperSciss[i] == `rock` || computerTurn == `scissors` && rockPaperSciss[i] == `paper`) {
                ...
                (0, _backendcalls.postUser)(result).then(()=>{
                    (0, _backendcalls.getHighScore)().then((0, _backendcalls.displayHighScores));
                });
                reset();
            } else {
...
},{"./modules/backendcalls":"h9TbA","./images/paper.jpg":"4NLdz","./images/rock.jpg":"fUT9t","./images/scissors.jpg":"kJHdd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h9TbA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"4NLdz":[function(require,module,exports) {
module.exports = require("5091fa940ce5a89e").getBundleURL("gnRNX") + "paper.9ec2ec10.jpg" + "?" + Date.now();

},{"5091fa940ce5a89e":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"fUT9t":[function(require,module,exports) {
module.exports = require("686c3671cac74ae1").getBundleURL("gnRNX") + "rock.558cba1f.jpg" + "?" + Date.now();

},{"686c3671cac74ae1":"lgJ39"}],"kJHdd":[function(require,module,exports) {
module.exports = require("84a4b9ea00c4f1c9").getBundleURL("gnRNX") + "scissors.b1c9d80d.jpg" + "?" + Date.now();

},{"84a4b9ea00c4f1c9":"lgJ39"}]},["f3BSW","gLLPy"], "gLLPy", "parcelRequire10c2")
